...
namespace Secao17.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 04, 21), 1000.00, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.00, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexG@gmail.com", new DateTime(1988, 01, 15), 2200.00, d1);
            ...
            Seller s6 = new Seller(6, "Alex Pink", "alexP@gmail.com", new DateTime(1997, 03, 04), 3000.00, d2);
            ...
            _context.Seller.AddRange(s1, s2, s3, s4, s4, s6);
